...
var marker_scene := preload("res://src/game_world/map_entities/marker/marker_entity.tscn")
var ruler_scene := preload("res://src/game_world/map_entities/ruler/ruler_entity.tscn")
