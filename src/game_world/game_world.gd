...
var missile_scene := preload("res://src/game_world/map_entities/missile/missile_entity.tscn")
...
func create_new_missile(
	...
	new_missile.rotation = (
		Vector2.DOWN.rotated(launcher.global_position.angle_to_point(launch_target)).angle()
	)
